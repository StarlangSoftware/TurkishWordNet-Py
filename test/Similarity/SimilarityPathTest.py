...
class SimilarityPathTest(unittest.TestCase):
    ...
    def test_ComputeSimilarity(self):
        ...
        self.assertAlmostEqual(38.0, similarityPath.computeSimilarity(turkish.getSynSetWithId("TUR10-0656390"), turkish.getSynSetWithId("TUR10-0600460")), 4)
        ...
        self.assertAlmostEqual(16.0, similarityPath.computeSimilarity(turkish.getSynSetWithId("TUR10-0195110"), turkish.getSynSetWithId("TUR10-0822980")), 4)
