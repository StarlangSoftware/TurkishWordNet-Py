...
class LCHTest(unittest.TestCase):
    ...
    def test_ComputeSimilarity(self):
        ...
        lch = LCH(turkish)
        self.assertAlmostEqual(2.9957, lch.computeSimilarity(turkish.getSynSetWithId("TUR10-0656390"), turkish.getSynSetWithId("TUR10-0600460")), 4)
        ...
        self.assertAlmostEqual(0.6360, lch.computeSimilarity(turkish.getSynSetWithId("TUR10-0195110"), turkish.getSynSetWithId("TUR10-0822980")), 4)
