...
class WuPalmerTest(unittest.TestCase):
    ...
    def test_ComputeSimilarity(self):
        ...
        self.assertAlmostEqual(0.9744, wuPalmer.computeSimilarity(turkish.getSynSetWithId("TUR10-0656390"), turkish.getSynSetWithId("TUR10-0600460")), 4)
        ...
        self.assertAlmostEqual(0.32, wuPalmer.computeSimilarity(turkish.getSynSetWithId("TUR10-0195110"), turkish.getSynSetWithId("TUR10-0822980")), 4)
