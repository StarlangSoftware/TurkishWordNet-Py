...
class WordNetTest(unittest.TestCase):
    ...
    def test_FindPathToRoot(self):
        ...
        self.assertEquals(4, len(self.turkish.findPathToRoot(self.turkish.getSynSetWithId("TUR10-0172740"))))
        ...
        self.assertEquals(10, len(self.turkish.findPathToRoot(self.turkish.getSynSetWithId("TUR10-1198750"))))
